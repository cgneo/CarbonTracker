...
void test_user(User *user){ // need to change this test
    try{        
         ...
         // user->birthday_is_vaild(); //this line is wrong, need to att a get_birthday() function
          ...
          vector<string> emails = {"james_smith@yahoo.com", "johnjohnson@gmail.com", "@.", "xyz.", "abc@", "d@y.c", "williams.brown@polytechnique.edu"};
          ...
          for (int i = 0; i < seeds.size(); i++)
                try{
                    ...
                    user->seeds_are_valid(); // Test if the name is valid
                }
                catch(...){
