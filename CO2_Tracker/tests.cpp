...
// User
void Tests::test_user(User *user){ // need to change this test
    try{
          vector<QString> names = {"James Smith","John Johnson","Robert Williams","Michael William Brown"};
         //Vector contains exceptions that crash, showing the function works
         ...
         // user->birthday_is_vaild(); //this line is wrong, need to att a get_birthday() function
          ...
          vector<QString> emails = {"james_smith@yahoo.com", "johnjohnson@gmail.com"};
          ...
          vector<int> living_partners = {1, 0, 1000, 100, 5, 3, 2};
    ...
    qDebug() << "Test: Set username passed";
